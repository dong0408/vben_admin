...
<template>
  <div class="flex h-screen w-full overflow-hidden bg-white">
    ...
    <div
      class="relative hidden w-1/2 items-center justify-center bg-[#f0f2f5] lg:flex"
    >
    ...
    <div
      class="flex w-full flex-col justify-center px-4 lg:w-1/2 lg:px-20 xl:px-32"
    >
      <div class="mx-auto w-full max-w-[400px]">
        ...
        <div class="mb-6 flex border-b border-gray-200">
          <button
            class="border-b-2 border-primary pb-2 font-medium text-primary"
          >
            账号登录
          </button>
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div class="flex items-center justify-between text-sm">
            <VbenCheckbox v-model="form.rememberMe"> 记住密码 </VbenCheckbox>
            <a
