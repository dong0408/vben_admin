...
/** 预警优先级标签颜色（Element Plus 的 tag 类型） */
...
export function useGridFormSchema(withTimeRange = true): VbenFormSchema[] {
  const schema: VbenFormSchema[] = [
    {
      component: 'Input',
      fieldName: 'vehicleName',
      label: '车辆名称',
      componentProps: { placeholder: '请输入车辆名称' },
    },
    {
      component: 'Input',
      fieldName: 'vehicleCode',
      label: '车辆编码',
      componentProps: { placeholder: '请输入车辆编码' },
    },
    {
      component: 'Input',
      fieldName: 'taskCode',
